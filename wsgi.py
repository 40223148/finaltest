...
class Hello(object):
    ...
    ctx.fillText("組員楊皓惟所繪製",x_g1-60, y_g1-10)
    ...
    '''
        ...
        return outstring
    #@+node:2015.20150623093743.1772: *3* test1
    @cherrypy.expose
    # N 為齒數, M 為模數, P 為壓力角
    def test1(self, N=20, m=None, p=None,z=None,x=None):
        outstring = '''
    <!DOCTYPE html> 
    <html>
    <head>
    ...
    # put it back
    ctx.translate(-x_g2, -y_g2)
    spur.Spur(ctx).Gear(x_g2, y_g2, rp_g2, n_g2, pa, "brown")
    ctx.restore()

    ctx.font = "10px Verdana";
    ctx.fillText("40223148所繪製",x_g1-60, y_g1-10)
    # 按照上面三個正齒輪的囓合轉角運算, 隨後的傳動齒輪轉角便可依此類推, 完成6個齒輪的囓合繪圖
